...
fn prove_method(a: f64, b: f64, operation: Operation, mut rule_set: RuleSet) -> Receipt {
    let env = ExecutorEnv::builder()
        .write(&(a,b,operation,rule_set))
        .unwrap()
        .build()
        .unwrap();
...
fn main() {
    ...
    tracing_subscriber::fmt()
        ...
        .init();
    let mut filter = qfilter::Filter::new(1000, 0.01).expect("Failed to create filter");
    let mut rule_set: RuleSet = RuleSet{rules: vec![], qf: filter};
